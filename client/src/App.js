...
import Era from "./components/sets/eras.component";
import EraInfo from "./components/info/eraInfo.component";
      ...
      <div className="App">
        <Router>
          <Switch>
            ...
            <Route path="/eras" component={Era} />
            <Route path="/era" component={EraInfo} />
